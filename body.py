...
"""
    scene = scene.replace(
        "</worldbody>",
        objects + '<camera name="frontcam" pos="0.0 -1.0 1.3" xyaxes="1 0 0 0 0.6 1" fovy="55"/><camera name="headcam" pos="0.08 -0.149 1.35" xyaxes="1 0 0 0 -0.3 1" fovy="90"/>' + "</worldbody>")
