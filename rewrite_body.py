# Complete clean rewrite of build_welded_scene
# Based on ALL measurements we have

BODY_CONTENT = '''import mujoco
...
def build_welded_scene():
    ...
    objects = """
    <body name="table" pos="0.350 -0.149 0.828">
    ...
    <body name="red_cube" pos="0.350 -0.149 0.878">
      <joint type="free"/>
    ...
    <body name="blue_cube" pos="0.350 -0.030 0.878">
      <joint type="free"/>
    ...
    <body name="green_cylinder" pos="0.350 -0.270 0.878">
      <joint type="free"/>
    ...
    <body name="place_target" pos="0.130 -0.299 0.828">
      <geom type="box" size="0.09 0.09 0.01"
...
import ast
try:
    ast.parse(BODY_CONTENT)
    print("✅ body.py written and syntax OK!")
